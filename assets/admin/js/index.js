...
const request = `https://superheroapi.com/api/10161262234158298/search/`;
...
function clickSuperhero (e) {
  
  let data = {
    'action': 'store_sh_data',
...
function renderResults (results) {
  results.results.forEach(element => {
    ...
    container.addEventListener("click", clickSuperhero)
    resultsDiv.appendChild(container);
  });
}


function getSuperHeroes (value) {
...
search.addEventListener("change", (e) => {
  const response = getSuperHeroes(e.target.value);
